...
public class FrontLineWorkerImporterTest {
    ...
    public void shouldValidateFLWRequests() {
        ...
        frontLineWorkerWebRequests.add(new FrontLineWorkerImportRequest("1234567890", "name", Designation.ANM.name(), new LocationRequest("D1", "B1", "P1", "VERIFIED")));
    ...
    public void shouldFailValidationIfFLWDoesNotHaveAllTheDetails() {
        ...
        Location location = new Location("D1", "B1", "P1", "VERIFIED");
        when(locationImportService.getFor("D1", "B1", "P1")).thenReturn(location);
        frontLineWorkerWebRequests.add(new FrontLineWorkerImportRequest("1asdf67890", "name", Designation.ANM.name(), new LocationRequest("D1", "B1", "P1", "VERIFIED")));
    ...
    public void shouldSaveFLW() throws IOException {
        ...
        frontLineWorkerWebRequests.add(new FrontLineWorkerImportRequest(msisdn, "name", Designation.ANM.name(), new LocationRequest("D1", "B1", "P1", "VERIFIED")));
