...
public class MsisdnImportServiceTest {
    ...
    public void shouldDeleteFLWByNewMsisdnAndUpdateFLWHavingOldMsisdnWithNewMsisdn() {
        ...
        MsisdnImportRequest msisdnImportRequest1 = setUpRequest(msisdn1, newMsisdn1);
        String msisdn2 = "9876543210";
        String newMsisdn2 = "9876543211";
        MsisdnImportRequest msisdnImportRequest2 = setUpRequest(msisdn2, newMsisdn2);
    ...
    public void shouldNotChangeMsisdnOfFLWIfRequestIsNotForChangeMsisdn() {
        ...
        MsisdnImportRequest msisdnImportRequest = setUpRequest(msisdn, "");
    ...
    private MsisdnImportRequest setUpRequest(String msisdn, String newMsisdn) {
        Long msisdnAsLong = PhoneNumber.formatPhoneNumber(msisdn);
        MsisdnImportRequest msisdnImportRequest = new MsisdnImportRequest(msisdn, newMsisdn, null);
