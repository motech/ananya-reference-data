...
public class LocationSyncRequestMapperTest {
    ...
    public void shouldMapLocationWithAlternateLocation() {
        Location alternateLocation = new Location("D1", "B1", "P1", LocationStatus.VALID.name(), null);
        Location location = new Location("D2", "B2", "P2", LocationStatus.NOT_VERIFIED.name(), alternateLocation);
    ...
    public void shouldMapLocationWithoutAlternateLocation() {
        Location location = new Location("D2", "B2", "P2", LocationStatus.NOT_VERIFIED.name(), null);
        location.setLastModified(DateTime.now());
