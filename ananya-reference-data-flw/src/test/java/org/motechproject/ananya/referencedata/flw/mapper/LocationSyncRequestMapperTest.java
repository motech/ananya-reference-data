...
public class LocationSyncRequestMapperTest {
    ...
    public void shouldMapLocationWithAlternateLocationWithDifferentState() {
        Location alternateLocation = new Location("s1", "D1", "B1", "P1", LocationStatus.VALID, null);
        Location location = new Location("s2", "D2", "B2", "P2", LocationStatus.NOT_VERIFIED, alternateLocation);
        location.setLastModified(DateTime.now());
