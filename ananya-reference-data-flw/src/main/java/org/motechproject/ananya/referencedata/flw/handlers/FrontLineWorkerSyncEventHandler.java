...
public class FrontLineWorkerSyncEventHandler {
    ...
    Logger logger = Logger.getLogger(FrontLineWorkerSyncEventHandler.class);

    @Autowired
    public FrontLineWorkerSyncEventHandler(JsonHttpClient jsonHttpClient, Properties clientServicesProperties, Properties referenceDataProperties) {
    ...
    public void handleSyncFrontLineWorker(MotechEvent event) {
        ...
        String url = (String) clientServicesProperties.get(SyncURLs.KEY_FRONT_LINE_WORKER_CREATE_URL);
